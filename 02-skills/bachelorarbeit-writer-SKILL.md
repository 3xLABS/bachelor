...
Verwende den Harvard-Zitierstil konsequent. Die Grundregeln:
...
*Beispiel:* "Der Anteil digitalisierter Geschäftsprozesse im deutschen Mittelstand stieg zwischen 2019 und 2023 von 34% auf 58% (vgl. BMWK, 2023, S. 17). Dieser Anstieg deutet darauf hin, dass..."
...
*Beispiel:* "Porter (2008, S. 214) definiert Wettbewerbsvorteile als... Diese Definition bildet die Grundlage für die folgende Analyse, da sie..."
...
- Zitate im Harvard-Stil inline
- Am Ende des Kapitels: ein Abschnitt `## Verwendete Quellen in diesem Kapitel` mit einer kurzen Auflistung der tatsächlich zitierten Quellen (als Hilfe für den User beim späteren Erstellen des Literaturverzeichnisses)
- Stellen, an denen Quellen fehlen: `[QUELLE ERGÄNZEN]`

Speichere die Datei im passenden Unterordner von `05-text/`, z.B. `05-text/02-Theoretischer Rahmen/kapitel_3_2_digitale_transformation.md`. Falls der Ordner nicht existiert, lege ihn an.
...
- Unter jeder Abbildung/Tabelle: Quellenangabe, z.B. "Quelle: Eigene Darstellung" oder "Quelle: In Anlehnung an Porter (2008, S. 214)"
...
|---|---|---|---|---|---|
| 2.1 Theoretische Grundlagen | kapitel_2_1_theoretische_grundlagen.md | 1.050 | 4 | 2026-03-29 | Erster Entwurf |

## Offene Punkte

- [QUELLE ERGÄNZEN] in Kapitel 2.1, Abschnitt 2.1.2 — Quelle zu fehlender strategischer Orientierung im Mittelstand benötigt
...
- Kapitelbezeichnung und Dateiname in der Tabelle
- Ungefähre Wort- und Seitenzahl
- Status: "Erster Entwurf", "Überarbeitet", "Final"
- Alle offenen `[QUELLE ERGÄNZEN]`-Stellen mit Kontext, damit der User weiß, welche Art von Quelle gesucht wird
